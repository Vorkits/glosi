...
dd={'Деловые услуги💰':['Юридические услуги','Бухгалтерские услуги','Транспортные услуги','Таможенно-брокерские услуги','Склады и хранение','Сертификация','Оценочные компании','Страхование','Нотариальные услуги','Банки и финансы','Лицензирование','Узаконение недвижимости','Переводчики'],
    'Маркетинг📈':['SEO','SMM','Дизайн','Копирайтинг','Фото-видео','Полиграфии','Реклама блогеров,пабликов'],
    'Разработка':['web-разработка','Приложения','Боты, и архетиктура','ИИ'],
    'Обучение':['Курсы','Репетиторы'],
